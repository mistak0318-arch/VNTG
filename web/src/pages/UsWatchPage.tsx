  ...
  return (
    <div className={font.className} style={font.style}>
      ...
      <div className="uw-stamp">
        ...
        {/*
          ⚠️ **문구가 실제와 다른 것이 제일 위험하다** (2026-09-08 — 벤티지 "이 문구도 변경해야
          되는 거 아니야 지금?"). 맞다. 여기는 「Yahoo Finance · 1분 캐시」라고 적혀 있었는데
          그날부터 창구가 셋이 됐다. 무엇이 어느 주기로 오는지를 그대로 적는다.
        */}
        <span className="uw-stamp-note">
          <b>초록 점</b>은 한투 실시간 체결(초당 몇 틱) · 점이 없으면 Yahoo 3초 시세 ·
          52주·강도·원화 같은 값은 정규장 1분 / 프리·애프터 15초 캐시입니다. ↻ 는 캐시를
          무시하고 새로 받습니다.
        </span>
      </div>
      ...
      */}
      ...
      {/*
        **그룹·종목 단추는 칩 줄 밖에** (2026-09-15 — 벤티지: "해외관심종목 메뉴에서 종목 그룹 추가하기 기능이
        없어졌다"). 폰(700px 이하)은 그룹을 고르개 하나로 보여 주면서 칩 줄을 통째로 감춘다
        (`.my-group-pick + .group-tabs`). 그런데 「＋ 그룹 · ＋ 종목 담기 · ✏ 편집」이 **그 칩 줄 안에** 있어서
        폰에선 셋이 같이 사라졌다 — 넓은 화면에선 보이니 「없어졌다」로 느껴졌다. 줄을 따로 세운다.
      */}
      <div className="filter-row uw-group-actions">
