      ...
      <div className="ov-grid" ref={gridRef}>
        ...
        */}
        ...
        {/*
          ...
          ⚠️ **제 칸(ov-span-all)에 따로 둔다** — 신호등과 같은 칸에 넣었더니 PC 에서 **안 보였다**
          (벤티지: "pc모드에서 네이버 ai 시황 이런거 안보이네"). 벽돌 쌓기(useMasonryGrid)가 카드가 아닌
          칸의 높이를 **첫 자식(신호등)으로만** 재서, 그 밑에 붙인 이 줄만큼 칸이 모자라 다음 카드가 위로
          덮었다. 폰은 한 열이라 잔줄을 안 써서 멀쩡했다 — PC 에서만 나는 병이었다.
        */}
        {sub === "summary" && (
          <div className="ov-span-all">
            <NaverBriefingBlock />
