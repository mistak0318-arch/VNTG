...
/**
 * 카드 접힘 상태 — **기기별**이다 (`prefs.LOCAL_ONLY`).
 *
 * ⚠️ 2026-09-01 까지 전역이었다. 주석에는 "접힌 상태를 기기별로 기억해서"라고
 * 적혀 있었고 카드에는 「📱 이 기기」 배지까지 그렸는데, `setPref` 가 서버로
 * 올려서 **27인치에서 펼쳐 둔 카드가 폰에서도 펼쳐졌다.**
 *
 * ⚠️ `scope` prop 은 **배지만 그린다** — 그 카드가 다루는 **설정 내용**이
 * 전역이냐 기기별이냐를 알려 주는 라벨이고, 접힘 상태와는 다른 층이다.
 * 헷갈리지 말 것: 접힘은 늘 기기별이다.
 */
