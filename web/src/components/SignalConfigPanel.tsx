      ...
      {!open ? null : (
        <div className="sig-guide-body">
          ...
          <p>
            ...
            <b>500 종목 × 400 거래일 = 19만 관측</b>을 놓고, 켤 수 있는 기준의{" "}
            <b>모든 조합(248개)</b>을 돌려서 정했습니다.
          </p>
          <p>
          ...
          <p>
            <b>켠 것 넷</b> — 정배열 · 60일 신고가 <span className="pt-n">(추세)</span> ·
            위쪽 매물 부담 · 5일선 이격 <span className="pt-n">(위험)</span>
          </p>
...
점수 구간별 (높을수록 좋아야 한다)
  ...
  90~100 +6.21%   ← 단조 증가`}
          ...
          <p>
            마지막 줄이 제일 중요합니다. <b>예전 설정에서는 점수 구간이 톱니</b>였습니다
            — 80~89점이 70~79점보다 나빴습니다. 점수가 높을수록 좋아야 「점수」라고 부를
            수 있습니다.
          </p>

          <p>
            <b>이번에 끈 것과 그 이유</b> — 둘 다 <b>거꾸로 걸려 있었습니다.</b>
          </p>
          <ul>
            <li>
              <b>테마 강세</b> — 가르는 힘 <b>-5.76%p</b>. 테마가 강한 날 산 것이 20일 뒤{" "}
              <b>-6.74%</b>, 테마가 약한 날은 -0.98% 였습니다. 추세 축에서 가중치 2를
              차지하면서 정반대로 작동했습니다. 읽자면{" "}
              <b>「테마가 강한 날 = 이미 급등한 날 = 되돌림 자리」</b>입니다. 테마가
              쓸모없다는 게 아니라, <b>그날 테마 등락률을 매수 근거로 쓰면 늦는다</b>는
              뜻입니다. 테마 화면과 슈퍼신호등의 테마 판정은 그대로입니다.
            </li>
            <li>
              <b>20일선 이격도</b> — 가르는 힘 <b>+2.45%p</b>. 위험 축은 「점수가 높으면
              위험하니 초록을 막는다」는 전제인데, 실제로는 20일선에서 많이 벌어진 쪽이{" "}
              <b>더 좋았습니다.</b> 막지 말아야 할 것을 막고 있었습니다.
            </li>
          </ul>

          <p>
            <b>일부러 안 한 것</b> — 훑기 1등은 「60일 신고가 + 5일선 이격」(+1.97%p)
            이었지만 그대로 쓰지 않았습니다. 그러면 사실상 <b>신고가 여부만 보는 이진
            판정</b>이 되어 점수 체계가 무의미해집니다. 248개 중 최고를 고르는 것 자체가
            과최적화입니다.
          </p>
          <p className="sim-note">
            ⚠️ <b>여섯 기준은 아직 채점 밖입니다</b> — ETF 뒷배 · 수급 3종 · 영업이익 ·
            시가총액. 그때의 값을 우리가 안 갖고 있어 되짚을 수 없을 뿐,{" "}
            <b>틀렸다는 근거는 없습니다.</b> 그래서 그대로 뒀습니다 — 잴 수 없다고 끄면
