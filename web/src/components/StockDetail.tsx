 ...
 *
 * ## ⚠️ 이제 본창에서는 안 뜬다 (2026-09-01)
 *
 * 본창에서 종목을 누르면 **개별종목분석 화면으로 간다.** 같은 속을 두 모양으로
 * 보여 주면서 좁은 쪽(시트)이 넓은 쪽(페이지)을 덮고 있었기 때문이다
 * — 벤티지: "통일하자. 어차피 걔가 정보 제일 많이 들고 있는데 뭐".
 *
 * 이 시트가 아직 사는 곳은 **탭이 없는 두 자리**뿐이다:
 *
 *   · `MiniPage` — 별도 창이라 옮겨 갈 탭이 없다
 *   · `EtfPanel` — 구성종목을 팝업으로 (2026-08-25 벤티지 요청:
 *     "닫으면 이 화면이 그대로 있다"가 ETF 를 훑는 방식이라 일부러 남겼다)
 */
