 ...
 *   ⚡ 교차    **주도주 ∩ 슈퍼신호등** (2026-09-01 정정). 슈퍼신호등 중 그날
 *              주도주 태그도 달린 종목이다 — 별도 체계가 아니라 **부분집합**이다.
 *              (예전 주석은 「맥박 교차 그룹」이라고 적혀 있었는데 틀렸다.
 *               marketPulse.findCross 가 leaderScan ∩ getActiveSuper 를 낸다)
 *
...
const LABEL: Record<SuperMark, { icon: string; short: string; title: string }> = {
  ...
  cross: {
    icon: "⚡",
    short: "교차",
    title: "교차 — 슈퍼신호등이면서 그날 주도주 태그도 달린 종목 (주도주 ∩ 슈퍼)",
  },
  rainbow: {
    icon: "🌈",
    short: "무지개(지속성)",
